...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS 'room_effect' ('id' INTEGER NOT NULL, 'reward_get' INTEGER NOT NULL, 'jukebox' INTEGER NOT NULL, 'nebbia' INTEGER NOT NULL, 'arcade' INTEGER NOT NULL, PRIMARY KEY('id'));
